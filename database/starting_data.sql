...
VALUES ('Willy Wonka and the Chocolate Factory (1971)', "A poor but hopeful boy seeks a coveted golden ticket that will send him on a tour of a mysterious chocolate factory.", 19.00, 25, 'static/images/willy_wonka.jpg', 'DVD');


INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('The Hobbit (Paperback)', "J.R.R. Tolkien's classic prelude to his Lord of the Rings trilogy. Join Bilbo Baggins as he finds himself roped into a quest to defeat Smaug the dragon!", 19.00, 50, 'static/images/hobbit.jpg', 'Book');
...
INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('The Shining (1980)', 'A family heads to an isolated hotel for the winter where a sinister presence influences the father into violence.', 16.00, 30, 'static/images/shining.jpg', 'DVD');
...
INSERT into `inventory` (`item_name`, `info`, `price`, `stock`, `image_url`, `category`)
VALUES ('Goosebumps: Night of the Living Dummy', "Double the dummies start to mean double the trouble...and horror.", 9.00, 100, 'static/images/goosebumps.jpg', 'Book');
